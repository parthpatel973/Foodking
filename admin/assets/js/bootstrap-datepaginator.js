...
;(function($, window, document, undefined) {
	...
	DatePaginator.defaults = {
		...
		size: undefined,
		startOfWeek: 'Mon',
		startOfWeekFormat: 'fff',
		squareEdges: false,
		text: 'ddd<br/>D',
		textSelected: 'ddd<br/>D',
		useBootstrap2: false,
		width: 0,
	...
	DatePaginator.prototype = {
		...
		_css: '.datepaginator{font-size:13px;height:50px;margin-top: 10px;}.datepaginator-sm{font-size:10px;height:40px}.datepaginator-lg{font-size:14px;height:80px;}.pagination{margin:0;padding:0;white-space:nowrap}.dp-nav{height:50px;padding:15px 0!important;width:20px;margin:0!important;text-align:center}.dp-nav-square-edges{border-radius:0!important}.dp-item{height:50px;/*padding:13px 0!important;*/width:35px;margin:0!important;border-left-style:hidden!important;text-align:center}.dp-item-sm{height:40px!important;padding:5px!important}.dp-item-lg{height:80px!important;padding:22px 0!important}.dp-nav-sm{height:40px!important;padding:11px 0!important}.dp-nav-lg{height:80px!important;padding:33px 0!important}a.dp-nav-right{border-left-style:hidden!important}.dp-divider{border-left:2px solid #ddd!important}.dp-off{background-color:#F0F0F0!important}.dp-no-select{color:#ccc!important;background-color:#F0F0F0!important}.dp-no-select:hover{background-color:#F0F0F0!important}.dp-today{border-bottom: 5px solid #ff0000 !important;;color:#fd1212!important}.dp-selected{border-bottom: 5px solid #ff0000 !important;;color:#fd1212!important;width:140px}#dp-calendar{padding:3px 5px 0 0!important;margin-right:3px;position:absolute;right:-3px;top:10}'
	};
